...
public class PhoneChannelService   {
  /**
  ...
  public PhoneChannelService name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Nome dos Serviços efetivamente prestados pelo Canal de Atendimento")
      @NotNull
  ...
  public PhoneChannelService code(CodeEnum code) {
    this.code = code;
    return this;
  }
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "Código dos Serviços efetivamente prestados pelo Canal de Atendimento")
      @NotNull
  ...
  public PhoneChannelService additionalInfo(String additionalInfo) {
  ...
  **/
  @ApiModelProperty(value = "Texto livre para complementar informação relativa ao Serviço disponível, quando for selecionada a opção 'OUTROS_PRODUTOS_SERVICOS'")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PhoneChannelService phoneChannelService = (PhoneChannelService) o;
    return Objects.equals(this.name, phoneChannelService.name) &&
        Objects.equals(this.code, phoneChannelService.code) &&
        Objects.equals(this.additionalInfo, phoneChannelService.additionalInfo);
  }
